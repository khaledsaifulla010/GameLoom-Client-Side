...
import loginGIF from "../../../assets/images/authentication/loginGIF.gif";
...
const LoginPage = () => {
  ...
  return (
    <div className="font-3">
      <div className="border-2 w-[1200px] ml-36 rounded-xl mb-36 mt-12">
        <h1 className="  text-5xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-pink-600 border p-8">
          Please Login
        </h1>
